...
| 010 | chassis-asset | Wie kommt die Gehäuse-Vorlage des Betreibers als Rahmen in die Werkbank? | **Ansatz steht** (15.08.2026): EIN Bild mit festem Seitenverhältnis + Bildfläche als Prozentkasten. 9-Slice verworfen — es streckt genau die Mitte, wo die Zeichnung sitzt. 43/78 KB | design, mining, werkbank, gehaeuse, asset |
