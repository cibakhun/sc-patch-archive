...
# Phase 8: Bauteil-Kennwerte auf den Crafting-Karten — Verifikationsbericht
...
`BroadSpec-Max`) tragen ihre Chips normal. Deckt sich mit dem 08-03-Sichtprüfungsbefund.
...
|---|---|---|---|---|
| CRAFT-01 | 08-01, 08-02 | Größe/Grade auf jeder Karte mit Angabe | ✓ SATISFIED | siehe Kriterium 1 |
| CRAFT-02 | 08-01, 08-02 | Ton, Schiffswaffen aus Kategorie-Pfad | ✓ SATISFIED | siehe Kriterium 2 |
| CRAFT-03 | 08-01, 08-02 | Kein geratener/leerer Chip, 15 Dubletten geprüft | ✓ SATISFIED | siehe Kriterien 3+4 |
| CRAFT-04 | 08-03 | Größe/Grade filterbar | ✓ SATISFIED | siehe Kriterium 6 |

Keine verwaisten Requirements — REQUIREMENTS.md führt für Phase 8 exakt CRAFT-01..04,
...
Keine offenen Punkte. Die visuelle/Kontrast-Prüfung (Aufgabe 2 aus Plan 08-03,
