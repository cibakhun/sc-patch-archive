...
export const ITEM_UI = {
  de: {
    ...
    setsNoHelmet: 'Kein Helm erfasst',
    ...
    sectionVariants: 'Varianten',
    variantsNote: 'Unter diesem Namen führt das Spiel mehrere Gegenstände. Sie unterscheiden sich in Größe und Werten — welchen ein Händler führt, hängt vom Angebot ab.',
    ...
    thAvg: 'Ø UEX',
    avgNote: 'Ø UEX = Mittelwert über alle gelisteten Kaufpreise dieses Items.',
    tableRegion: 'Tabelle, scrollbar',
    pagination: 'Seiten',
    page: 'Seite',
    prevPage: '← Zurück',
    nextPage: 'Weiter →',
    ...
    // Erz-Pods und Mining-Module (4.10). Die Modifikator-Namen folgen der
    // Benennung des Mining-Werkzeugs, nicht der internen Feldnamen.
    bpCargo: 'Fassungsvermögen', bpHealth: 'Haltbarkeit',
    bpMin_optimal_charge_window_size: 'Optimales Ladefenster',
    bpMin_optimal_charge_window_rate: 'Laderate im Fenster',
    bpMin_catastrophic_charge_window_rate: 'Überladungsrate',
    bpMin_instability: 'Instabilität',
    bpMin_resistance: 'Widerstand',
    bpMin_shatter_damage: 'Splitterschaden',
    bpMin_cluster_factor: 'Streuung',
    bpMin_filter: 'Filterwirkung',
    ...
    bpMissionsNote: 'Drop-Chance je Pool; mehrere Blueprints teilen sich einen Pool.',
    bpNoMissions: 'Keine Missions-Quelle bekannt — evtl. über Shop oder Reputation erhältlich.',
  ...
  en: {
    ...
    variantsNote: 'The game ships several distinct items under this name. They differ in size and performance — which one a shop stocks depends on its inventory.',
    ...
    thAvg: 'UEX avg',
    avgNote: 'UEX avg = mean of all listed buy prices for this item.',
    tableRegion: 'Table, scrollable',
    pagination: 'Pages',
    page: 'Page',
    prevPage: '← Previous',
    nextPage: 'Next →',
    ...
    bpCargo: 'Capacity', bpHealth: 'Durability',
    bpMin_optimal_charge_window_size: 'Optimal charge window',
    bpMin_optimal_charge_window_rate: 'Charge rate in window',
    bpMin_catastrophic_charge_window_rate: 'Overcharge rate',
    bpMin_instability: 'Instability',
    bpMin_resistance: 'Resistance',
    bpMin_shatter_damage: 'Shatter damage',
    bpMin_cluster_factor: 'Cluster factor',
    bpMin_filter: 'Filter effect',
    ...
    bpMissionsNote: 'Drop chance per pool; several blueprints share one pool.',
    bpNoMissions: 'No mission source known — may be obtainable via shop or reputation.',
    bpDropChance: 'Drop chance',
