...
const UI = {
  de: {
    ...
    'holo.panel.estimated': 'Position ungefähr: aus den Spieldateien, auf ein nachgebautes Modell übertragen.',
    ...
    'holo.src': 'Komponenten-Positionen aus den Spieldateien',
    // Für Schiffe, bei denen KEIN Marker eine echte Position hat (kein Hardpoint
    // im Mesh) — die Herkunfts-Zeile darf dort keine Verortung behaupten.
    'holo.src.none': 'Komponenten laut Spieldaten — Positionen schematisch, nicht verortet',
    ...
    'tf.documented': 'Abgelegt unter Alpha %v% — ',
  ...
  en: {
    ...
    'holo.panel.estimated': 'Approximate position: taken from the game files, mapped onto a fan-made model.',
    ...
    'holo.src': 'Component positions from the game files',
    'holo.src.none': 'Components per game data — positions schematic, not located',
    ...
    'tf.documented': 'Filed under Alpha %v% — ',
