...
export const HELP = {
  de: {
    ...
    'mining.step4': 'Mit dem Anheft-Knopf auf einer Kachel ein Erz nach rechts heften und den Scanwert eintippen, um eine Signatur zuzuordnen.',
  ...
  en: {
    ...
    'mining.step4': 'Hit the pin button on an ore tile to pin it on the right, then type a scan value to identify a signature.',
    ...
    'mining.ctl.presets': 'Named sets of this list. Saved to your account and available on every device.',
