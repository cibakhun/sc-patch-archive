...
export const HELP = {
  de: {
    ...
    'mining.step6': 'Der Knopf in der Ecke dieser Spalte legt sie in ein eigenes, frei verschiebbares Fenster. In Chrome, Edge und Opera bleibt es über allen anderen Fenstern liegen — auch neben dem laufenden Spiel, sofern das im randlosen Fenstermodus läuft.',
    ...
    'missions.ctl.filter': 'Öffnet die Filterleiste auf schmalen Bildschirmen.',
  ...
  en: {
    ...
    'mining.step6': 'The button in that column’s corner moves it into its own free-floating window. In Chrome, Edge and Opera it stays on top of every other window — next to the running game too, as long as that runs in borderless windowed mode.',
    ...
    'missions.ctl.filter': 'Opens the filter bar on narrow screens.',
