...
export const DISCOVERED_REGISTRY = [
  ...
  },
  {
    ...
    // (1) Das Band ist ein AUSSCHNITT. Bei 1280x225 mit background-size:cover
    //     zeigt es vom 1919x823-Bild nur den Streifen yFrac 0.295..0.705; der
    //     Titel liegt darin bei 0.508..0.660. Der erste Anlauf stand auf 0.78 —
    ...
    //     200,196,192) und damit der unguenstigste Fall, den dieses Modell
    //     ueberhaupt sehen kann.
    anchor: { xFrac: 0.67, yFrac: 0.522 },
